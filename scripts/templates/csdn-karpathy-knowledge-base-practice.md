# 用 Git 仓库实践 Karpathy 的个人知识库方法：零软件依赖的完整方案

> **本文首发于 [maoxunxing.com](https://maoxunxing.com/zh-cn/karpathy-knowledge-base-practice/)**，转载请注明出处。更多 AI、知识管理与 Hugo 相关文章，欢迎访问我的博客。
...
**视频讲解**（CSDN 请用外链打开）：[How to Build a Personal LLM Knowledge Base (Karpathy's Method)](https://www.youtube.com/watch?v=VRub1w-APTc)
...
如果你对 AI 辅助开发感兴趣，可以看：[AI Coding 实战手册：工具选型、工作流与提示词模板](https://maoxunxing.com/zh-cn/ai-coding-practice/)。  
工作流与职场视角的补充阅读：[AI 重构工作流：当人效提升 10 倍，职场人如何穿越周期？](https://maoxunxing.com/zh-cn/ai-rewriting-workflow/)
...
# CSDN 编辑器设置备忘（不要粘贴进正文）

# 标题: 用 Git 仓库实践 Karpathy 的个人知识库方法：零软件依赖的完整方案
# 摘要: 受 Karpathy 启发，用 Git + Markdown + LLM 建立 raw→notes→posts 三层管道，不依赖 Obsidian，与 Hugo 博客同仓完成收集到发布。
# 标签: AI, 知识管理, Hugo, Markdown, 个人知识库
# 分类: 人工智能 / 开发工具（按账号实际选）
# 原文链接: https://maoxunxing.com/zh-cn/karpathy-knowledge-base-practice/

# 源文: content/posts/karpathy-knowledge-base-practice/index.zh-cn.md
# 相对 Hugo: {{< youtube >}} 已替换为 YouTube 直链
